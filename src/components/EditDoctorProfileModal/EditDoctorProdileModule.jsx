...
const EditDoctorProfileModal = ({ open, setApp }) => {
    const [selectedData, setSelectData] = useState(dayjs);

    const handleDateChange = newData => {
        const formattedDate = newData.format('DD.MM.YYYY');
    ...
    const initialValues = { name: '', gender: '', date: selectedData, phone: '', about: '' };
